...
//or put my channel link in the deYTion.
...
//[target]\\
	const reply = (teks) => {
            XeonBotInc.sendMessage(m.chat, { text: teks, contextInfo:{"externalAdReply": {"title": ` ${global.botnma}`,"body": ` Join Bot's Official GC`, "previewType": "PHOTO","thumbnailUrl": ``,"thumbnail": fs.readFileSync(`./XeonMedia/cheemspic.jpg`),"sourceUrl": "https://chat.whatsapp.com/HYj9wu5Jrv6CROxyeQbH"}}}, { quoted: m})
        }
        
        const replay = (teks) => {
            XeonBotInc.sendMessage(m.chat, { text: teks, contextInfo:{"externalAdReply": {"title": ` ${global.botnma}`,"body": ` Subscribe Bot's Official YT Channel`, "previewType": "PHOTO","thumbnailUrl": ``,"thumbnail": fs.readFileSync(`./XeonMedia/cheemspic.jpg`),"sourceUrl": "https://youtu.be/WKX-lz1K51U"}}}, { quoted: m})
        }
try {
...
Please @${m.mentionedJid[0].split`@`[0]} to type accept/reject`
	    ...
	    case 'donasi': case 'donate': case 'sewabot': case 'sewa': case 'buypremium': case 'donate': {
            ...
            break
            case 'sc': case 'YT': {
                reply('YT : https://youtu.be/dpCdHYacJBg\n Dont Forget To Give Star\n\nYoutube : https://youtu.be/WKX-lz1K51U\n Dont Forget To Subscribe')
            }
            break
            case 'chat': {
	...
	break
	    case 'setname': case 'setsubject': {
          ...
          case 'setdesc': case 'setdesk': {
                ...
                if (!isAdmins) throw mess.admin
                if (!text) throw 'Text ?'
                await XeonBotInc.groupUpdateDeYTion(m.chat, text).then((res) => reply(mess.success)).catch((err) => reply(jsonformat(err)))
            }
            break
            ...
            case 'bcgc': case 'bcgroup': {
                ...
                for (let i of anu) {
                    ...
                    let btn = [{
                                urlButton: {
                                    displayText: 'YouTube📍',
                                    url: 'https://youtu.be/dpCdHYacJBg'
                                }
                            }, {
                                callButton: {
...
const template = generateWAMessageFromContent(m.chat, proto.Message.fromObject({
                    templateMessage: {
                        hydratedTemplate: {
                            ...
                            hydratedFooterText: `Shikmori Bot-MD`,
                            hydratedButtons: [{
                                urlButton: {
                                    displayText: 'YouTube📍',
                                    url: 'https://youtu.be/WKX-lz1K51U'
                                }
                            }, {
                            	urlButton: {
                                displayText: 'YT🔖',
...
const template = generateWAMessageFromContent(m.chat, proto.Message.fromObject({
                    templateMessage: {
                        hydratedTemplate: {
                            ...
                            locationMessage: {
                            jpegThumbnail: fs.readFileSync('./XeonMedia/cheemspic.jpg')},
                            hydratedFooterText: `Hi Darling 👸💖 ${pushname}
How Are You Darling,Quit Missed You More Awww? 😊
...
let template = await generateWAMessageFromContent(m.chat, proto.Message.fromObject({
                listMessage :{
                    title: `Hi ${pushname}`,
                    deYTion: `Please Choose The Menu\n\n`,
                    buttonText: "Menu",
                    footerText: "_Shikmori Bot-MD_",
                    ...
                    sections: [{
								...
								"rows": [
									{
										"title": "Group Menu",
										"deYTion": "Displays The List Of Group Features",
							...
							},
							{
								...
								"rows": [
									{
										"title": "All Menu",
										"deYTion": "Displays The List Of All The Features!",
										"rowId": `${prefix}allmenu`
									},
									{
										"title": "Download Menu",
										"deYTion": "Displays The List Of Download Features",
										"rowId": `${prefix}downloadmenu`
									},
									{
										"title": "Search Menu",
										"deYTion": "Displays The List Of Searching Features",
										"rowId": `${prefix}searchmenu`
									},
										{
											"title": "Image Menu",
										"deYTion": "Displays The List Of Image Features",
										"rowId": `${prefix}imagemenu`
										},
										{
											"title": "Fun Menu",
										"deYTion": "Displays The List Of Fun Features",
										"rowId": `${prefix}funmenu`
										},
										{
											"title": "Convert Menu",
										"deYTion": "Displays The List Of Convert Features",
										"rowId": `${prefix}convertmenu`
										},
										{
										"title": "Miscellaneous Menu",
										"deYTion": "Displays The List Of Miscellaneous Features",
										"rowId": `${prefix}nocategorymenu`
										},
										{
											"title": "Database Menu",
										"deYTion": "Displays The List Of Database Features",
										"rowId": `${prefix}databasemenu`
										},
										{
											"title": "Voice Changer Menu",
										"deYTion": "Displays The List Of Voice Changing Features",
								...
								"rows": [
									{
										...
										"deYTion": "Displays The List Of Anonymous Chat Features",
							...
							},
							{
								...
								"rows": [
									{
										"title": "System Menu",
										"deYTion": "Displays The List Of Group System Features",
							...
							},
							{
								...
								"rows": [
									{
										"title": "Owner Menu",
										"deYTion": "Displays The List Of Owner Features",
							...
							},
							{
								...
								"rows": [
									{
										"title": "Thanks To",
										"deYTion": "Displays The List Of Credit Of The Bot !!",
										"rowId": `${prefix}tqtt`
									}
								]
							}
...
Xeon (Me)
My family
And all friends who helped assemble this sexy YT !!!`)
break
            default:
                if (budy.startsWith('=>')) {
